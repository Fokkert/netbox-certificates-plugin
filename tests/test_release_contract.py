...
class ReleaseContractTests(unittest.TestCase):
    ...
    def test_release_metadata_is_1_0_0(self):
        ...
        self.assertIn("version: 1.0.2", plugin)
        self.assertIn('version = "1.0.2"', config)
    ...
    def test_readme_is_product_focused(self):
        ...
        self.assertIn("NetBox Certificates Plugin", readme)
        self.assertIn("netbox-certificates-plugin==1.0.2", readme)

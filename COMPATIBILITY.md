...
The 1.3.0 revision has standalone behavioral and template checks. Full NetBox runtime and migration checks have not been run in this Windows workspace; see VALIDATION.md.

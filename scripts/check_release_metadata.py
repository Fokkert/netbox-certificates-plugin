...
if 'version = "1.3.5"' not in pyproject:
    errors.append("pyproject.toml does not declare version 1.3.5")
if "version: 1.3.5" not in plugin_yaml:
    errors.append("netbox-plugin.yaml does not declare version 1.3.5")
if 'version = __version__' not in config or '__version__ = "1.3.5"' not in read('netbox_certificates/version.py'):
    errors.append("PluginConfig does not declare version 1.3.5")

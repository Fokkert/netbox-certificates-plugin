...
if 'version = "1.3.1"' not in pyproject:
    errors.append("pyproject.toml does not declare version 1.3.1")
if "version: 1.3.1" not in plugin_yaml:
    errors.append("netbox-plugin.yaml does not declare version 1.3.1")
if 'version = __version__' not in config or '__version__ = "1.3.1"' not in read('netbox_certificates/version.py'):
    errors.append("PluginConfig does not declare version 1.3.1")
...
print("Release metadata and integration contract checks passed.")

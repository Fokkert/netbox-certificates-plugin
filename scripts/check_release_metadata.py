...
if 'version = "1.0.5"' not in pyproject:
    errors.append("pyproject.toml does not declare version 1.0.5")
if "version: 1.0.5" not in plugin_yaml:
    errors.append("netbox-plugin.yaml does not declare version 1.0.5")
if 'version = "1.0.5"' not in config:
    errors.append("PluginConfig does not declare version 1.0.5")

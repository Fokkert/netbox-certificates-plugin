...
if 'version = "1.1.2"' not in pyproject:
    errors.append("pyproject.toml does not declare version 1.1.2")
if "version: 1.1.2" not in plugin_yaml:
    errors.append("netbox-plugin.yaml does not declare version 1.1.2")
if 'version = "1.1.2"' not in config:
    errors.append("PluginConfig does not declare version 1.1.2")

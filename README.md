...
NetBox Certificates Plugin 0.4.11 supports:

- NetBox 4.5.9 — fully validated
...
```bash
echo 'netbox-certificates-plugin==0.4.11' \
...
See [VALIDATION.md](VALIDATION.md) for release notes and maintain your own staging/integration validation before upgrading NetBox or this plugin.
